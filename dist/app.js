...
var apiKey = '6a422154a25b68752d7dd8ace95bc5ae';
let requestToken;
let username;
let password;
let sessionId;
...
let criarlista = document.getElementById('criar-lista');
let nomeLista = document.getElementById('nomelista');
let descricaoLista = document.getElementById('descricao-lista');
...
criarlista.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    criarLista(nomeLista, descricaoLista);
}));
